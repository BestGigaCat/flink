...
if is_local:
    ...
    APPLICATION_PROPERTIES_FILE_PATH = CURRENT_DIR + "/application_properties.json"  # local
...
def main():
    ...
    table_result = table_env.execute_sql("INSERT INTO {0} SELECT ticker, price, event_time FROM {1}"
